        ...
        <div class="col-sm-5">
          <div class="row">
            <div class="col-sm-3 footer-seal">
              <img src="{!! asset('/imgs/footer-seal.png') !!}" alt="Seal for California State University, Northridge">
            </div>
            <div class="col-sm-9">
              <ul class="list--unstyled">
                <li><strong>Curriculum Web Service</strong> <br>© California State University, Northridge</li>
